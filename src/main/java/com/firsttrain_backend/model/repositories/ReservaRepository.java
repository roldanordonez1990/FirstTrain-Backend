...
public interface ReservaRepository extends CrudRepository<Reserva, Integer>{
	...
	@Query(value="SELECT id_usuario, nombre, apellidos, fecha, horas, id_reservas FROM usuario as u, reserva as re, horario as ho "
			+ "WHERE re.id_hora = ho.id_horario and re.id_usu = u.id_usuario ORDER BY horas", nativeQuery = true)
	public List<DTO> getTodasLasReservasMezcla();
